...
We recently created a static app using [Next.js](https://nextjs.org/), [React](https://reactjs.org/) and [Netlify](https://netlify.com). Everything was fine until we stumbled upon this error for invalid routes.
